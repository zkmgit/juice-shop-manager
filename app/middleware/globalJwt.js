...
// swagger资源不拦截
const whiteList = [ '/wxApi/user/getToken', '/wxApi/user/login', '/api/wxUser/login', '/api/user/login', '/', '/swagger-ui.html', '/swagger-ui.css', '/swagger-ui-bundle.js', '/swagger-ui-standalone-preset.js', '/favicon-32x32.png', '/favicon-16x16.png', '/swagger-doc' ];
