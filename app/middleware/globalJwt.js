...
// swagger资源不拦截
const whiteList = [ '/wxApi/user/getToken', '/wxApi/user/login', '/wxApi/system/carouselImageList', '/wxApi/announcement/AnnouncementList', '/wxApi/category/getAllCategoryList',
